      ...
      <div className="dbhs-content">
        <ul className="list-group">
          <li className="list-btn py-2 fz:14 d-flex aic jcb bg-primary:30 border-primary:70">
            ...
            <span className="fw-500 text-dark">Money Flow Problem</span>
          </li>

          <div className="input-group mt-3">
            <label className="input-label fw-600 text-dark">Flow Type</label>
            <div className="input-field not-icon mt-0">
              <input
                type="text"
                id="order-id"
                placeholder="Enter The Flow Type Here"
...
export default MoneyFlowProblem;
